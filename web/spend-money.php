...
<div class="flex-container">
  ...
  <div class="main" <?php if ($lang!='zh') echo "style='display:none;'";?>>
    ...
    <a id="spend_money_vip"></a>
    <h3>高回报氪金 - 订阅VIP</h3>
    <p>
      花费的最有效方法是购买VIP订阅。 价格因国家和平台（iOS或Android）而异。 例如，在美国，iOS每月9.99美元，Android每月9.49美元。而在其他地区可能比美国区贵，也可能便宜。以下是一些主要好处： </p>
    <ul>
      <li>跳过所有广告</li>
